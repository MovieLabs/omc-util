...
export namespace basicName {
    ...
    export namespace graphQl_2 {
        ...
        export namespace filter_2 {
            let fullName_4: string;
            export { fullName_4 as fullName };
            let altName_4: string;
            export { altName_4 as altName };
        }
...
export namespace scriptName {
    export namespace template_3 {
        export namespace fullName_5 {
            let $type_11: string;
            export { $type_11 as $type };
        }
        export { fullName_5 as fullName };
        export namespace altName_5 {
            let $type_12: string;
            export { $type_12 as $type };
        }
        export { altName_5 as altName };
        export namespace scriptName {
            let $type_13: string;
    ...
    export namespace graphQl_3 {
        export namespace properties_3 {
            let fullName_6: string;
            export { fullName_6 as fullName };
            let altName_6: string;
            export { altName_6 as altName };
            let scriptName_1: string;
            export { scriptName_1 as scriptName };
        }
        export { properties_3 as properties };
        export namespace filter_3 {
            let fullName_7: string;
            export { fullName_7 as fullName };
            let altName_7: string;
            export { altName_7 as altName };
            let scriptName_2: string;
            export { scriptName_2 as scriptName };
        }
...
export namespace baseEntity {
    ...
    export namespace graphQl_7 {
        ...
        let inlineFragment_7: any;
        export { inlineFragment_7 as inlineFragment };
    }
    export { graphQl_7 as graphQl };
}
