...
export const generalConfig = {
    ...
    Context: {
        ...
        presentation: {
            ...
            propRows: ['name', 'contextType', 'contextCategory'],
        },
    },
    Depiction: {
        group: 'Media Creation Context',
